// AUDIT FIX (consolidation): toBanglaNumber used to be an independent
// local copy of the same digit-conversion logic in utils/bnEnDate.ts.
// Imported from there now (single source of truth) and re-exported so
// EmployeeNoticeView.tsx / EmployeeNotice.tsx's existing
// `import { toBanglaNumber } from './LeftNoticeDataType'` keeps working
// unchanged.
