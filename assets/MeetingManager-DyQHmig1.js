import{K as A,r as k,u as P,j as e,L as re,M as se,N as oe,O as le,R as L,a as de,G as ce,H as pe}from"./index-C-xuqBI7.js";import{B as X,P as ee,u as ge}from"./printCSS-Br-GwSZh.js";import{D as F,M as xe}from"./ModuleShell-BmVvs9s4.js";import"./DatabaseFactory-d-naj0b2.js";import"./AuthorityIconButton-DqOfheAu.js";import"./DataUseCases-CJmSGyHU.js";const he=["মাসিক","দ্বি-মাসিক","ত্রৈমাসিক","অর্ধ-বার্ষিক","বার্ষিক","বিশেষ","অত্যাবশ্যক","বোর্ড","কমিটি","প্রকল্প","দল","অন্যান্য"],me=["Pending","In Progress","Completed"];A.map(t=>({id:t.id,name:t.name,address:t.address}));A.flatMap(t=>t.committees.map(n=>({id:`${t.id}__${n.id}`,name:n.name,chairperson:n.chairperson,secretary:n.secretary})));const $={organizationName:"",organizationAddress:"",department:"",meetingTitle:"",meetingEstablishDate:"",meetingType:"মাসিক",meetingNumber:"",noticeDate:new Date().toISOString().split("T")[0],meetingDate:new Date().toISOString().split("T")[0],startTime:"",endTime:"",venue:"",virtualMeetingLink:"",meetingImage:"",chairperson:"",secretary:"",attendees:[],previousMinutesReference:"",previousMinutesApproval:"N/A",previousMinutesRejectionDetails:"",agendaItems:[],generalNotes:"",closingNotes:"",annexures:[],nextMeetingDate:"",nextMeetingTime:"",nextMeetingVenue:"",preparedBy:"",preparedByDesignation:"",preparedDate:new Date().toISOString().split("T")[0],reviewedBy:"",reviewedByDesignation:"",reviewedDate:"",approvedBy:"",approvedByDesignation:"",approvedDate:"",authority1:"",authority1Designation:"কারখানা প্রধান",authority1Date:"",authority2:"",authority2Designation:"ব্যবস্থাপক (মানবসম্পদ, প্রশাসন ও সম্মতি)",authority2Date:"",showPreparedBy:!0,showReviewedBy:!0,showApprovedBy:!0,showAuthority1:!0,showAuthority2:!0,distributionList:[]},be=(t,n)=>{if(!t||!n)return"";const[i,r]=t.split(":").map(Number),[p,a]=n.split(":").map(Number);let h=i*60+r,g=p*60+a;g<h&&(g+=1440);const x=g-h;if(x<=0)return"";const s=Math.floor(x/60),m=x%60;return s>0&&m>0?`${s} hour${s>1?"s":""} ${m} minute${m>1?"s":""}`:s>0?`${s} hour${s>1?"s":""}`:`${m} minute${m>1?"s":""}`},I=()=>`${Date.now()}-${Math.random().toString(36).substr(2,9)}`,te=t=>{const n=t.filter(a=>a.attendanceStatus==="Present").length,i=t.filter(a=>a.attendanceStatus==="Absent").length,r=t.length,p=r>0?Math.round(n/r*100):0;return{present:n,absent:i,total:r,presentPercentage:p}},fe=(t="MIN")=>{const n=new Date().getFullYear(),i=Math.floor(Math.random()*1e3).toString().padStart(3,"0");return`${t}-${n}-${i}`},O=["কোরাম নিশ্চিতকরণ ও বিগত সভার কার্যবিবরণী ফলো-আপ","ঝুঁকি মূল্যায়ন ও রিস্ক রেজিস্টার পর্যালোচনা (Risk Assessment & Risk Register)","DIFE রিপোর্টিং ও বার্ষিক নিরাপত্তা প্রতিবেদন প্রস্তুতি","কমিটির নিজস্ব ওএইচএস (OSH) বাজেট ও সুপারিশ ট্র্যাকিং","ডিজিটাল সেফটি ডাটাবেজ এবং রিপোর্টিং (LIMA সিস্টেম)","অগ্নি নির্বাপণ সরঞ্জাম ও অ্যালার্ম সিস্টেমের কার্যকারিতা তদারকি","জরুরি বহির্গমন পথ (Emergency Exits) ও ইভাকুয়েশন রুট বাধামুক্ত রাখা","ফায়ার মক ড্রিল (Mock Drills) ও উদ্ধার মহড়ার মূল্যায়ন","আবহাওয়া এবং প্রাকৃতিক দুর্যোগ প্রস্তুতি (ভূমিকম্প ও বজ্রপাত)","ফ্লাড এবং আরবান ওয়াটার-লগিং (আকস্মিক বন্যা ও জলাবদ্ধতা) ঝুঁকি ব্যবস্থাপনা","কর্মক্ষেত্রের দুর্ঘটনা ও পেশাগত ব্যাধি তদন্ত","নিয়ার-মিস (Near-miss) বা 'অল্পের জন্য বেঁচে যাওয়া' ঘটনার রিপোর্টিং","নতুন মেশিনারিজ স্থাপন এবং লে-আউট পরিবর্তনজনিত ঝুঁকি মূল্যায়ন","বিপজ্জনক যন্ত্রপাতির সেফটি গার্ডিং (Machine Guarding) নিশ্চিতকরণ","কার্গো লিফট, ক্রেন এবং প্রেসার ভেসেল (বয়লার/কম্প্রেশার) পরিদর্শন","বৈদ্যুতিক সাব-স্টেশন, জেনারেটর ও ডিস্ট্রিবিউশন বোর্ডের ঝুঁকি তদারকি","ভবনের স্থায়িত্ব ও স্ট্রাকচারাল সেফটি (মেঝে, দেয়াল ও ছাদ) পরিদর্শন","ফ্লোরের তাপমাত্রা (Heat Stress), বাতাস চলাচল (Ventilation) ও লাইটিং ব্যবস্থা","তীব্র দাবদাহ (Heatwave Management) এবং চরম আবহাওয়ার প্রভাব মোকাবেলা","ক্ষতিকারক ধুলোবালি, গ্যাস, ধোঁয়া, বর্জ্য নিষ্কাশন ও শব্দ দূষণ নিয়ন্ত্রণ","আরগোনোমিক্স (Ergonomics) ও ভারী ওজন তোলার সঠিক পদ্ধতি (Manual Lifting)","কর্মক্ষেত্রে শ্রমিকদের মানসিক স্বাস্থ্য ও মনস্তাত্ত্বিক নিরাপত্তা নিশ্চিতকরণ","কর্মক্ষেত্রে যৌন হয়রানি ও মানসিক নির্যাতন প্রতিরোধে ওএইচএস (OSH) লিংক","কেমিক্যাল এবং বিপজ্জনক পদার্থের নিরাপত্তা (MSDS, লেবেলিং ও স্পিল কিট)","কনফাইন্ড স্পেস বা বদ্ধ স্থানে (ট্যাংক, সুয়ারেজ) কাজের নিরাপত্তা","উঁচুতে কাজের নিরাপত্তা (Work at Height) ও পতন রোধ ব্যবস্থা (সেফটি হার্নেস ও নেট)","বিশেষ ঝুঁকিপূর্ণ কাজের অনুমতি ব্যবস্থা (Permit to Work - PTW)","ব্যক্তিগত সুরক্ষা সরঞ্জাম (PPE) বিতরণ এবং সঠিক ব্যবহার নিশ্চিতকরণ","ফার্স্ট এইড বক্স, মেডিকেল রুম, বিশুদ্ধ খাবার পানি ও পরিচ্ছন্ন টয়লেট ব্যবস্থা","ঠিকাদার, সাব-কন্ট্রাক্টর ও আউটসোর্সিং শ্রমিকদের সেফটি প্রটোকল তদারকি","বিশেষ চাহিদা সম্পন্ন ও গর্ভবতী নারী শ্রমিকদের নিরাপত্তা","নিরাপত্তা প্রশিক্ষণ ও সচেতনতা (OSH Training) ও সেফটি সাইনেজ প্রদর্শন"],ue=["কনফারেন্স রুম","কনফারেন্স হল","বোর্ড রুম","ট্রেনিং রুম","ডাইনিং হল","কারখানার প্রধান কক্ষ","মিটিং রুম","অডিটোরিয়াম"];function ye(t){if(!t)return{male:0,female:0,total:0};const n=[];t.chairpersonGender&&n.push(t.chairpersonGender),t.secretaryGender&&n.push(t.secretaryGender);for(const i of t.members??[])i.gender&&n.push(i.gender);return{male:n.filter(i=>i==="পুরুষ").length,female:n.filter(i=>i==="মহিলা").length,total:n.length}}function je(t,n){if(!t)return"";const[i,r]=t.split(":").map(Number),p=(i+n)%24;return`${String(p).padStart(2,"0")}:${String(r).padStart(2,"0")}`}const ve=["02-21","03-26","04-14","05-01","11-07","12-16"];function R(t){if(t.getDay()===5)return!0;const n=`${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}`;return ve.includes(n)}function we(t,n){if(!t)return"";const i=new Date(t);let r=0;for(;r<n;)i.setDate(i.getDate()+1),R(i)||r++;return i.toISOString().split("T")[0]}function ke(t,n){if(!t)return"";const i=new Date(t);let r=0;for(;r<n;)i.setDate(i.getDate()-1),R(i)||r++;return i.toISOString().split("T")[0]}function W(t){if(!t)return"";const n=new Date(t);for(;R(n);)n.setDate(n.getDate()+1);return n.toISOString().split("T")[0]}const _=8;function Ne(t){return t?parseInt(t.split(":")[0])>=12?{text:"বিকাল",bg:"#e0e7ff",color:"#4338ca"}:{text:"সকাল",bg:"#fef3c7",color:"#92400e"}:null}const Se=["০","১","২","৩","৪","৫","৬","৭","৮","৯"];function ne(t){return String(t).split("").map(n=>Se[parseInt(n)]??n).join("")}function Ae(t){return{id:I(),itemNumber:String(t),topic:"",presenter:"",timeAllocated:"",discussion:"",decisions:[],actionItems:[]}}function De({onSelect:t,onClose:n,currentValue:i}){const[r,p]=k.useState(""),a=k.useRef(null);k.useEffect(()=>{setTimeout(()=>a.current?.focus(),80)},[]),k.useEffect(()=>{const g=x=>{x.key==="Escape"&&n()};return window.addEventListener("keydown",g),()=>window.removeEventListener("keydown",g)},[n]);const h=r.trim()?O.filter(g=>g.toLowerCase().includes(r.toLowerCase())||g.includes(r)):O;return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"apm-backdrop",onClick:n}),e.jsxs("div",{className:"apm-modal",role:"dialog","aria-modal":"true","aria-label":"আলোচ্যসূচি নির্বাচন",children:[e.jsxs("div",{className:"apm-header",children:[e.jsxs("div",{className:"apm-header-left",children:[e.jsx("i",{className:"ti ti-list-check"}),e.jsx("span",{children:"আলোচ্যসূচি নির্বাচন করুন"}),e.jsxs("span",{className:"apm-count",children:[h.length,"টি বিষয়"]})]}),e.jsx("button",{className:"apm-close",onClick:n,title:"বন্ধ করুন",children:e.jsx("i",{className:"ti ti-x"})})]}),e.jsxs("div",{className:"apm-search-wrap",children:[e.jsx("i",{className:"ti ti-search apm-search-icon"}),e.jsx("input",{ref:a,type:"text",className:"apm-search",placeholder:"বিষয় খুঁজুন...",value:r,onChange:g=>p(g.target.value),lang:"bn"}),r&&e.jsx("button",{className:"apm-search-clear",onClick:()=>p(""),children:e.jsx("i",{className:"ti ti-x"})})]}),e.jsxs("ul",{className:"apm-list",children:[h.length===0&&e.jsx("li",{className:"apm-empty",children:"কোনো বিষয় পাওয়া যায়নি"}),h.map((g,x)=>e.jsxs("li",{className:`apm-item ${i===g?"apm-item-active":""}`,onClick:()=>{t(g),n()},children:[e.jsx("span",{className:"apm-item-num",children:ne(x+1)}),e.jsx("span",{className:"apm-item-text",children:g}),i===g&&e.jsx("i",{className:"ti ti-check apm-item-check"})]},x))]}),e.jsxs("div",{className:"apm-footer",children:[e.jsxs("span",{className:"apm-footer-hint",children:[e.jsx("i",{className:"ti ti-keyboard"})," Esc চাপলে বন্ধ হবে"]}),e.jsx("button",{className:"apm-cancel-btn",onClick:n,children:"বাতিল"})]})]})]})}function Te({value:t,onChange:n}){const[i,r]=k.useState(!1),p=k.useCallback(a=>{n(a)},[n]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"ai-wrap",children:[e.jsx("input",{type:"text",className:"bis-ag-input",value:t,onChange:a=>n(a.target.value),placeholder:"আলোচ্যসূচি লিখুন...",lang:"bn"}),e.jsx("button",{className:"ai-pick-btn",onClick:()=>r(!0),title:"তালিকা থেকে নির্বাচন করুন",type:"button",children:e.jsx("i",{className:"ti ti-layout-list"})})]}),i&&e.jsx(De,{currentValue:t,onSelect:p,onClose:()=>r(!1)})]})}function ze({minutes:t,setMinutes:n}){const i=P();k.useEffect(()=>{const d=A.find(b=>b.id===i.id)??A[0];d&&n({...t,organizationName:d.name,organizationAddress:d.address})},[i.id]);const r=d=>n({...t,...d}),p=()=>r({agendaItems:[...t.agendaItems,Ae(t.agendaItems.length+1)]}),a=(d,b)=>r({agendaItems:t.agendaItems.map(o=>o.id===d?{...o,topic:b}:o)}),h=d=>r({agendaItems:t.agendaItems.filter(b=>b.id!==d).map((b,o)=>({...b,itemNumber:String(o+1)}))}),g=d=>{const o=((A.find(c=>c.name===t.organizationName)??A[0])?.committees??A.flatMap(c=>c.committees)).find(c=>c.id===d);o&&r({meetingTitle:o.name,meetingEstablishDate:o.establishDate??t.meetingEstablishDate,meetingNumber:fe(),chairperson:o.chairperson,secretary:o.secretary,attendees:x(o)})},x=d=>{const b=[{id:I(),name:d.chairperson,designation:d.chairpersonDesignation??"",department:d.chairpersonDept??"",email:"",attendanceStatus:"Present",committeeRole:"সভাপতি"},{id:I(),name:d.secretary,designation:d.secretaryDesignation??"",department:d.secretaryDept??"",email:"",attendanceStatus:"Present",committeeRole:"সচিব"},...(d.members??[]).map(c=>({id:I(),name:c.name,designation:c.designation,department:c.section,email:"",attendanceStatus:"Present",committeeRole:c.role??"সদস্য"}))],o=Array.from({length:1},()=>({id:I(),name:"",designation:"",department:"",email:"",attendanceStatus:"Present",committeeRole:"অতিথি"}));return[...b,...o]},s=A.find(d=>d.name===t.organizationName),m=s?s.committees:A.flatMap(d=>d.committees),f=m.find(d=>d.name===t.meetingTitle),j=ye(f),w=Ne(t.startTime);return e.jsxs("div",{className:"bis-wrap",children:[e.jsxs("div",{className:"bis-card",children:[e.jsxs("div",{className:"bis-card-header",children:[e.jsx("i",{className:"ti ti-calendar-event","aria-hidden":"true"}),e.jsx("span",{children:"মিটিং সময়সূচি"})]}),e.jsxs("div",{className:"bis-body",children:[e.jsxs("div",{className:"bis-field bis-r1a",children:[e.jsx("label",{className:"bis-label",children:"কমিটি নির্বাচন *"}),e.jsxs("select",{className:"bis-select",value:m.find(d=>d.name===t.meetingTitle)?.id??"",onChange:d=>g(d.target.value),children:[e.jsx("option",{value:"",children:"— কমিটি নির্বাচন করুন —"}),m.map(d=>e.jsx("option",{value:d.id,children:d.name},d.id))]}),f&&e.jsxs("p",{className:"bis-hint bis-hint-green",children:["✓ সভাপতি: ",f.chairperson," · সচিব: ",f.secretary,j.total>0&&e.jsxs("span",{children:[" · মোট ",j.total," জন (",e.jsxs("span",{style:{color:"#db2777"},children:["নারী ",j.female]})," / ",e.jsxs("span",{style:{color:"#1d4ed8"},children:["পুরুষ ",j.male]}),")"]})]})]}),e.jsxs("div",{className:"bis-field bis-r1b",children:[e.jsx("label",{className:"bis-label",children:"মিটিং ধরন *"}),e.jsx("select",{className:"bis-select",value:t.meetingType,onChange:d=>r({meetingType:d.target.value}),children:he.map(d=>e.jsx("option",{value:d,children:d},d))})]}),e.jsxs("div",{className:"bis-field bis-r2a",children:[e.jsx("label",{className:"bis-label",children:"স্থান/রুম *"}),e.jsx("input",{type:"text",className:"bis-input",value:t.venue,onChange:d=>r({venue:d.target.value}),placeholder:"কনফারেন্স রুম",list:"bis-venue-list",lang:"bn"}),e.jsx("datalist",{id:"bis-venue-list",children:ue.map(d=>e.jsx("option",{value:d},d))})]}),e.jsxs("div",{className:"bis-field bis-r2b",children:[e.jsx("label",{className:"bis-label",children:"নোটিশের তারিখ *"}),e.jsx("input",{type:"date",className:"bis-input",value:t.noticeDate,onChange:d=>{const b=W(d.target.value),o=we(b,_);r({noticeDate:b,meetingDate:o})}})]}),e.jsxs("div",{className:"bis-field bis-r2b-meet",children:[e.jsx("label",{className:"bis-label",children:"মিটিংয়ের তারিখ *"}),e.jsx("input",{type:"date",className:"bis-input",value:t.meetingDate,onChange:d=>{const b=W(d.target.value),o=ke(b,_);r({meetingDate:b,noticeDate:o})}})]}),e.jsxs("div",{className:"bis-field bis-r2c",children:[e.jsx("label",{className:"bis-label",children:"শুরুর সময় *"}),e.jsxs("div",{style:{position:"relative"},children:[e.jsx("input",{type:"time",className:"bis-input",value:t.startTime,onChange:d=>{const b=d.target.value;r({startTime:b,endTime:je(b,2)})},style:{paddingRight:w?72:12}}),w&&e.jsx("span",{className:"bis-time-badge",style:{background:w.bg,color:w.color},children:w.text})]})]})]})]}),e.jsxs("div",{className:"bis-card",style:{marginTop:16},children:[e.jsxs("div",{className:"bis-card-header",children:[e.jsx("i",{className:"ti ti-list-check","aria-hidden":"true"}),e.jsx("span",{children:"আলোচ্যসূচি"}),e.jsxs("button",{className:"bis-add-btn",onClick:p,children:[e.jsx("i",{className:"ti ti-plus","aria-hidden":"true"})," যোগ করুন"]})]}),e.jsxs("table",{className:"bis-ag-table",children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:52}}),e.jsx("col",{}),e.jsx("col",{style:{width:44}})]}),e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"ক্রম"}),e.jsx("th",{style:{textAlign:"left"},children:"আলোচ্যসূচি"}),e.jsx("th",{})]})}),e.jsxs("tbody",{children:[t.agendaItems.length===0&&e.jsx("tr",{children:e.jsx("td",{colSpan:3,className:"bis-ag-empty",children:"কোনো আলোচ্যসূচি নেই — উপরে + যোগ করুন চাপুন"})}),t.agendaItems.map((d,b)=>e.jsxs("tr",{children:[e.jsx("td",{className:"bis-ag-sl",children:ne(b+1).padStart(2,"০")}),e.jsx("td",{className:"bis-ag-topic",children:e.jsx(Te,{value:d.topic,onChange:o=>a(d.id,o)})}),e.jsx("td",{className:"bis-ag-del",children:e.jsx("button",{className:"bis-ag-del-btn",onClick:()=>h(d.id),title:"মুছুন",children:e.jsx("i",{className:"ti ti-x","aria-hidden":"true"})})})]},d.id))]})]})]}),e.jsx("style",{children:`
      ...
      `})]})}const Ce="সম্মানিত উপস্থিত সকলকে স্বাগত জানিয়ে সভাপতি সভার কার্যক্রম শুরু করেন। তিনি সকলের উপস্থিতির জন্য ধন্যবাদ জ্ঞাপন করেন এবং আজকের সভার মূল আলোচ্যসূচি সম্পর্কে সংক্ষিপ্ত ধারণা প্রদান করেন।",$e="আলোচ্যসূচির সকল বিষয়ে আলোচনা সম্পন্ন হওয়ার পর সভাপতি উপস্থিত সকল সদস্যকে তাঁদের গঠনমূলক মতামত ও সক্রিয় অংশগ্রহণের জন্য ধন্যবাদ জানান। পরবর্তী সভার তারিখ ও সময় যথাসময়ে জানানো হবে মর্মে উল্লেখ করে তিনি সভার সমাপ্তি ঘোষণা করেন।";function He({label:t,variant:n="orange"}){const r={default:{bg:"#f1f5f9",border:"#94a3b8",color:"#475569"},blue:{bg:"#eff6ff",border:"#3b82f6",color:"#1d4ed8"},green:{bg:"#f0fdf4",border:"#22c55e",color:"#065f46"},purple:{bg:"#faf5ff",border:"#a855f7",color:"#6b21a8"},orange:{bg:"#fff7ed",border:"#f97316",color:"#9a3412"}}[n];return e.jsx("div",{className:"ocs-block-title",style:{background:r.bg,borderLeftColor:r.border,color:r.color},children:t})}function Y({label:t,variant:n,value:i,onChange:r,placeholder:p,template:a}){const h=()=>{r(i?`${i}

${a}`:a)};return e.jsxs("div",{className:"ocs-card",children:[e.jsxs("div",{className:"ocs-card-head",children:[e.jsx(He,{label:t,variant:n}),e.jsx("button",{type:"button",className:"ocs-template-btn",onClick:h,children:"টেমপ্লেট যোগ করুন"})]}),e.jsx("textarea",{value:i,onChange:g=>r(g.target.value),className:"ocs-textarea",rows:9,placeholder:p,lang:"bn"})]})}function Pe({minutes:t,setMinutes:n}){return e.jsxs("div",{className:"ocs-wrap",children:[e.jsxs("div",{className:"ocs-grid",children:[e.jsx(Y,{label:"উদ্বোধনী",variant:"orange",value:t.generalNotes,onChange:i=>n({...t,generalNotes:i}),placeholder:"সভার উদ্বোধনী বক্তব্য, প্রারম্ভিক মন্তব্য বা পর্যবেক্ষণ লিখুন...",template:Ce}),e.jsx(Y,{label:"সমাপনী",variant:"blue",value:t.closingNotes,onChange:i=>n({...t,closingNotes:i}),placeholder:"সভার সমাপনী বক্তব্য বা সংক্ষিপ্ত উপসংহার লিখুন...",template:$e})]}),e.jsx("style",{children:`
        .ocs-wrap { width: 100%; }
      ...
      `})]})}const Fe=k.memo(Le);function Oe({minutes:t,setMinutes:n}){const[i,r]=k.useState(!1),p=k.useRef(null),a=1200,h=800,g=Array.isArray(t.meetingImage)?t.meetingImage:t.meetingImage?[t.meetingImage]:[],x=f=>new Promise(j=>{const w=new FileReader;w.onload=d=>{const b=new Image;b.onload=()=>{const o=p.current;if(!o)return;const c=o.getContext("2d",{alpha:!1});if(!c)return;o.width=a,o.height=h;const u=Math.max(a/b.width,h/b.height),D=a/2-b.width/2*u,N=h/2-b.height/2*u;c.fillStyle="#FFFFFF",c.fillRect(0,0,a,h),c.drawImage(b,D,N,b.width*u,b.height*u);const M=t.meetingDate||new Date().toISOString().split("T")[0],l=t.startTime||new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!1}),y=`${M.split("-").reverse().join("/")} ${l}`;c.save(),c.font='bold 32px "Courier New", Courier, monospace',c.textAlign="right",c.shadowColor="rgba(0, 0, 0, 0.8)",c.shadowBlur=4,c.lineWidth=4,c.strokeStyle="rgba(0, 0, 0, 0.6)",c.strokeText(y,a-40,h-40),c.shadowBlur=0,c.fillStyle="#ff9800",c.fillText(y,a-40,h-40),c.restore(),j(o.toDataURL("image/jpeg",.85))},b.src=d.target?.result},w.readAsDataURL(f)}),s=async f=>{const j=f.target.files;if(!j||j.length===0)return;r(!0);const w=[];for(let d=0;d<j.length;d++){const b=await x(j[d]);w.push(b)}n({...t,meetingImage:[...g,...w]}),r(!1),f.target.value=""},m=f=>{const j=g.filter((w,d)=>d!==f);n({...t,meetingImage:j[0]??""})};return e.jsxs("div",{className:"w-full",children:[e.jsx("canvas",{ref:p,className:"hidden"}),e.jsx("div",{className:"bg-white rounded-2xl border border-slate-200 overflow-hidden",children:e.jsx("div",{className:"p-4 sm:p-6",children:e.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-4 gap-4 sm:gap-6",children:[e.jsxs("div",{className:"sm:col-span-1 flex flex-row sm:flex-col gap-3",children:[e.jsxs("div",{className:"flex-1 p-3 sm:p-4 bg-slate-50 rounded-xl border border-slate-200",children:[e.jsxs("label",{className:"text-[11px] font-black text-slate-400 uppercase flex items-center gap-2 mb-2",children:[e.jsx(re,{"aria-hidden":"true"})," তারিখ ও সময়"]}),e.jsx("p",{className:"text-sm font-bold text-slate-700",children:t.meetingDate||"—"}),e.jsx("p",{className:"text-xs text-slate-500 font-medium",children:t.startTime||"—"})]}),e.jsx("input",{id:"multi-upload",type:"file",accept:"image/*",multiple:!0,onChange:s,className:"hidden"}),e.jsxs("label",{htmlFor:"multi-upload",className:"flex-1 flex flex-col items-center justify-center min-h-[100px] sm:min-h-[140px] border-2 border-dashed border-slate-200 rounded-2xl hover:border-indigo-400 hover:bg-indigo-50 transition-all cursor-pointer group",children:[e.jsx("div",{className:"p-3 bg-white shadow-md rounded-full mb-2 group-hover:scale-110 transition-transform",children:e.jsx(se,{className:"text-indigo-600"})}),e.jsx("span",{className:"text-xs font-bold text-slate-600",children:"ফটো যোগ করুন"}),e.jsx("span",{className:"text-[10px] text-slate-400 mt-1 uppercase font-bold",children:"একাধিক নির্বাচন"}),g.length>0&&e.jsxs("span",{className:"mt-1 text-[10px] font-bold text-indigo-500",children:[g.length," টি ফটো"]})]})]}),e.jsx("div",{className:"sm:col-span-3",children:g.length>0?e.jsxs("div",{className:"grid grid-cols-2 gap-3 max-h-[60vh] overflow-y-auto pr-1",children:[g.map((f,j)=>e.jsxs("div",{className:"relative group rounded-xl overflow-hidden border border-slate-200 shadow-sm bg-slate-50",children:[e.jsx("img",{src:f,alt:`Photo ${j+1}`,className:"w-full aspect-[3/2] object-cover"}),e.jsx("div",{className:"absolute inset-0 bg-slate-900/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center",children:e.jsx("button",{onClick:()=>m(j),className:"p-3 bg-white text-rose-600 rounded-full shadow-xl hover:bg-rose-600 hover:text-white transition-all",children:e.jsx(oe,{size:16})})}),e.jsxs("div",{className:"absolute top-2 left-2 px-2 py-0.5 bg-black/60 rounded text-[10px] text-white font-black",children:["#",j+1]})]},j)),i&&e.jsxs("div",{className:"w-full aspect-[3/2] bg-indigo-50 rounded-xl border-2 border-dashed border-indigo-200 flex flex-col items-center justify-center animate-pulse",children:[e.jsx("div",{className:"w-8 h-8 border-4 border-indigo-500 border-t-transparent rounded-full animate-spin mb-2"}),e.jsx("p",{className:"text-[10px] font-black text-indigo-400 uppercase",children:"প্রক্রিয়াকরণ..."})]})]}):e.jsxs("div",{className:"w-full min-h-[220px] sm:min-h-[350px] bg-slate-50 rounded-2xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-300",children:[e.jsx(le,{size:36,className:"opacity-20 mb-3"}),e.jsx("p",{className:"text-sm font-bold text-slate-400",children:"কোনো ফটো নেই"}),e.jsx("p",{className:"text-xs text-slate-300 mt-1",children:"বাম দিক থেকে ফটো যোগ করুন"})]})})]})})})]})}const z=t=>{if(t==null)return"";const n={0:"০",1:"১",2:"২",3:"৩",4:"৪",5:"৫",6:"৬",7:"৭",8:"৮",9:"৯"};return t.toString().replace(/\d/g,i=>n[i])},We=["রবিবার","সোমবার","মঙ্গলবার","বুধবার","বৃহস্পতিবার","শুক্রবার","শনিবার"],_e=["জানুয়ারি","ফেব্রুয়ারি","মার্চ","এপ্রিল","মে","জুন","জুলাই","আগস্ট","সেপ্টেম্বর","অক্টোবর","নভেম্বর","ডিসেম্বর"],Ge=t=>{if(!t)return"";const n=new Date(t),i=We[n.getDay()],r=z(String(n.getDate()).padStart(2,"0")),p=_e[n.getMonth()],a=z(n.getFullYear());return`${i}, ${r} ${p} ${a}`},Je=t=>({Present:"উপস্থিত",Absent:"অনুপস্থিত"})[t]??t;function Ye(t){const n=t.filter(r=>r.committeeRole!=="অতিথি"),i=t.filter(r=>r.committeeRole==="অতিথি");return{members:n,guests:i}}function V({rows:t}){return e.jsxs("table",{className:"pl-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{style:{width:"6%"},children:"ক্রম"}),e.jsx("th",{style:{width:"20%",textAlign:"left"},children:"নাম"}),e.jsx("th",{style:{width:"16%",textAlign:"left"},children:"পদবি"}),e.jsx("th",{style:{width:"18%",textAlign:"left"},children:"বিভাগ / সেকশন"}),e.jsx("th",{style:{width:"12%"},children:"কমিটিতে ভূমিকা"}),e.jsx("th",{style:{width:"12%"},children:"উপস্থিতি"}),e.jsx("th",{style:{width:"16%"},children:"স্বাক্ষর"})]})}),e.jsx("tbody",{children:t.map((n,i)=>e.jsxs("tr",{children:[e.jsx("td",{style:{textAlign:"center"},children:z(i+1)}),e.jsx("td",{children:n.name}),e.jsx("td",{children:n.designation}),e.jsx("td",{children:n.department}),e.jsx("td",{style:{textAlign:"center"},children:n.committeeRole||"—"}),e.jsx("td",{style:{textAlign:"center",fontWeight:600},children:n.name?Je(n.attendanceStatus):""}),e.jsx("td",{})]},n.id??i))})]})}function Ue({minutes:t}){const[n,i]=L.useState(()=>{try{return localStorage.getItem("rms-theme")==="dark"}catch{return!1}});L.useEffect(()=>{const s=()=>{try{i(localStorage.getItem("rms-theme")==="dark")}catch{}};return window.addEventListener("storage",s),()=>window.removeEventListener("storage",s)},[]);const{members:r,guests:p}=Ye(t.attendees),a=te(r),h=t.attendees.length,g=h<=15?12:h<=22?11:h<=30?10:9,x=h<=15?9:h<=22?7:h<=30?5:4;return e.jsxs("div",{className:"pl-page",style:{"--pl-row-font":`${g}px`,"--pl-row-pad":`${x}px 8px`,background:"#ffffff",color:"#000000"},children:[e.jsxs("div",{className:"pl-header",children:[e.jsx("h1",{className:"pl-org",children:t.organizationName}),t.organizationAddress&&e.jsx("p",{className:"pl-org-addr",children:t.organizationAddress}),e.jsx("h2",{className:"pl-title",children:(t.meetingTitle||"--")+" এর উপস্থিতি তালিকা"}),e.jsxs("p",{className:"pl-date",children:["তারিখ: ",Ge(t.meetingDate)]})]}),e.jsxs("p",{className:"pl-summary",children:["মোট: ",z(a.total)," |  উপস্থিত: ",z(a.present)," |  অনুপস্থিত: ",z(a.absent)," |  উপস্থিতির হার: ",z(a.presentPercentage),"%"]}),r.length>0&&e.jsxs("div",{className:"pl-section",style:{marginBottom:p.length>0?"20px":"0"},children:[e.jsxs("p",{className:"pl-section-title",children:["কমিটি সদস্য (",z(r.length)," জন)"]}),e.jsx(V,{rows:r})]}),p.length>0&&e.jsxs("div",{className:"pl-section",children:[e.jsxs("p",{className:"pl-section-title",children:["অতিথি (",z(p.length)," জন)"]}),e.jsx(V,{rows:p})]}),e.jsx("style",{children:`
        ${X}
        ${ee}
      ...
      `})]})}const v=t=>{if(t==null)return"";const n={0:"০",1:"১",2:"২",3:"৩",4:"৪",5:"৫",6:"৬",7:"৭",8:"৮",9:"৯"};return t.toString().replace(/\d/g,i=>n[i])},ie=["রবিবার","সোমবার","মঙ্গলবার","বুধবার","বৃহস্পতিবার","শুক্রবার","শনিবার"],E=["জানুয়ারি","ফেব্রুয়ারি","মার্চ","এপ্রিল","মে","জুন","জুলাই","আগস্ট","সেপ্টেম্বর","অক্টোবর","নভেম্বর","ডিসেম্বর"],Ve=t=>{try{const n=new Date(t),i=v(n.getDate()),r=E[n.getMonth()],p=v(n.getFullYear());return`${i} ${r}, ${p}`}catch{return"[তারিখ]"}},H=t=>{if(!t)return"";const n=new Date(t),i=v(String(n.getDate()).padStart(2,"0")),r=E[n.getMonth()],p=v(n.getFullYear());return`${i} ${r} ${p}`},Ze=t=>{if(!t)return"";const n=new Date(t),i=ie[n.getDay()],r=v(String(n.getDate()).padStart(2,"0")),p=E[n.getMonth()],a=v(n.getFullYear());return`${i}, ${r} ${p} ${a}`},Z=t=>{if(!t)return"";const[n,i]=t.split(":"),p=parseInt(n)%12||12;return`${v(String(p).padStart(2,"0"))}:${v(i)}`},B=t=>{if(!t)return"";const n=parseInt(t.split(":")[0]);return n>=5&&n<12?"সকাল":n>=12&&n<15?"দুপুর":n>=15&&n<18?"বিকাল":n>=18&&n<20?"সন্ধ্যা":"রাত"},Ke=t=>{if(!t)return"[সময়]";let[n,i]=t.split(":").map(Number);n=n%12||12;const r=i<10?`০${i}`:i;return v(`${n}:${r}`)},qe=t=>t?t.replace(/(\d+)/g,n=>v(n)).replace("hours","ঘণ্টা").replace("hour","ঘণ্টা").replace("minutes","মিনিট").replace("minute","মিনিট"):"";function Qe(t){if(!t)return"";try{const n=new Date(t),i=new Date(t);i.setFullYear(i.getFullYear()+2),i.setDate(i.getDate()-1);const r=p=>{const a=["জানুয়ারি","ফেব্রুয়ারি","মার্চ","এপ্রিল","মে","জুন","জুলাই","আগস্ট","সেপ্টেম্বর","অক্টোবর","নভেম্বর","ডিসেম্বর"],h=g=>String(g).split("").map(x=>"০১২৩৪৫৬৭৮৯"[+x]).join("");return`${h(p.getDate())} ${a[p.getMonth()]} ${h(p.getFullYear())}`};return`২ বছর  [${r(n)} - ${r(i)}]`}catch{return""}}const Xe=t=>({Present:"উপস্থিত",Absent:"অনুপস্থিত",Excused:"অনুমতিপ্রাপ্ত",Late:"বিলম্বিত"})[t]??t,K=t=>!!t&&/[\u0980-\u09FFa-zA-Z0-9]/.test(t),q=t=>{if(!t)return"";const n=t.split(`
...
`).trimEnd()};function et(t){if(!t)return{male:0,female:0,total:0};const n=[];t.chairpersonGender&&n.push(t.chairpersonGender),t.secretaryGender&&n.push(t.secretaryGender);for(const p of t.members??[])p.gender&&n.push(p.gender);const i=n.filter(p=>p==="পুরুষ").length,r=n.filter(p=>p==="মহিলা").length;return{male:i,female:r,total:n.length}}const tt=t=>t?Array.isArray(t)?t.filter(Boolean):typeof t=="string"&&t.length>0?[t]:[]:[];function nt({status:t}){const n=[{key:"Pending",label:"অপেক্ষমান"},{key:"In Progress",label:"চলমান"},{key:"Completed",label:"সম্পন্ন"}];return e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"6px"},children:n.map(i=>{const r=t===i.key;return e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"6px"},children:[e.jsx("div",{style:{width:"13px",height:"13px",border:"1.5px solid #333",borderRadius:"2px",backgroundColor:"transparent",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}),e.jsx("span",{style:{fontSize:"11px",fontWeight:r?"bold":"normal",color:r?"#000":"#555",lineHeight:"1.3"},children:i.label})]},i.key)})})}function it({minutes:t}){const n=t.meetingDate?ie[new Date(t.meetingDate).getDay()]:"[দিন]",i=t.meetingDate?Ve(t.meetingDate):"[তারিখ]",r=t.startTime?Ke(t.startTime):"[সময়]",p={fontSize:"20px",lineHeight:"1.8",textAlign:"justify",margin:"0",fontWeight:"normal",color:"#000",paddingLeft:"0"};return e.jsxs("div",{style:{width:"100%",display:"flex",flexDirection:"column",gap:"24px"},children:[e.jsxs("p",{style:p,children:["এতদ্বারা ",t.organizationName||"[কারখানার নাম]"," এর ",t.meetingTitle||"[কমিটির নাম]"," -র সকল সদস্যগণের অবগতির জন্য জানানো যাচ্ছে যে, আগামী ",i," ইং তারিখ রোজ ",n," ",B(t.startTime)&&e.jsxs("span",{children:[B(t.startTime)," "]})," ",r," ঘটিকার সময় কারখানার অভ্যন্তরে ",t.venue||"[স্থান]"," এ একটি জরুরী আলোচনা সভা অনুষ্ঠিত হবে।"]}),e.jsxs("p",{style:p,children:["উক্ত সভায় ",t.meetingTitle||"[কমিটির নাম]"," -র সকল সদস্যগণকে যথা সময়ে নির্দিষ্ট স্থানে উপস্থিত থাকার জন্য বিশেষভাবে অনুরোধ করা হলো।"]})]})}function at({src:t,index:n}){return e.jsx("div",{style:{position:"relative",display:"block"},children:e.jsx("img",{src:t,alt:`মিটিং ছবি ${n+1}`,style:{width:"100%",height:"auto",maxHeight:"320px",border:"2px solid black",objectFit:"contain",display:"block"}})})}function Q({minutes:t,printOption:n,viewSections:i,authorization:r}){const p=P(),a=te(t.attendees),h=be(t.startTime,t.endTime),g=tt(t.meetingImage),s=A.find(o=>o.name===t.organizationName)?.committees.find(o=>o.name===t.meetingTitle),m=et(s),f=o=>{if(i)switch(o){case"basic":return i.basic;case"attendance":return i.attendance;case"agenda":return i.agenda;case"notice":return i.notice;case"approval":return i.approval;default:return!1}return n==="all"||n==="basic"&&(o==="basic"||o==="agenda")||n==="attendance"&&o==="attendance"||n==="agenda"&&o==="agenda"||n==="notice"&&o==="notice"},j=i?i.approval:n!=="notice"&&n!=="attendance",w=!!r&&(r.visibility.hrManager||r.visibility.factoryHead||r.visibility.hoHrHead||r.visibility.headOfOperations||!!(r.visibility?.president&&r.president)||!!(r.visibility?.secretary&&r.secretary)),d=[{label:"মিটিং ধরন",value:t.meetingType},{label:"তারিখ",value:Ze(t.meetingDate)},{label:"সময়",value:e.jsxs(e.Fragment,{children:[B(t.startTime)&&e.jsxs("span",{style:{fontWeight:"600"},children:[B(t.startTime)," "]}),Z(t.startTime)," –"," ",B(t.endTime)&&e.jsxs("span",{style:{fontWeight:"600"},children:[B(t.endTime)," "]}),Z(t.endTime),h&&` (মোট: ${qe(h)})`]})},{label:"স্থান",value:t.venue},{label:"সভাপতি",value:t.chairperson},{label:"সচিব",value:t.secretary},...t.meetingEstablishDate?[{label:"কমিটির মেয়াদকাল",value:Qe(t.meetingEstablishDate)}]:[],...m.total>0?[{label:"মোট সদস্য",value:`নারী ${v(m.female)} জন (${v(Math.round(m.female/m.total*100))}%), পুরুষ ${v(m.male)} জন (${v(Math.round(m.male/m.total*100))}%), মোট ${v(m.total)} জন`}]:[],...t.meetingNumber?[{label:"রেফারেন্স নম্বর",value:t.meetingNumber}]:[]],b=(o=!1)=>{const c=r,u=p.authorities,D=[{show:!!(c&&c.visibility?.president&&c.president),name:c?.president??"",desig:c?.presidentDesignation??"সভাপতি",sub:t.meetingTitle,date:"",label:"--"},{show:!!(c&&c.visibility?.secretary&&c.secretary),name:c?.secretary??"",desig:c?.secretaryDesignation??"সচিব",sub:t.meetingTitle,date:"",label:"--"},{show:!!c?.visibility.hrManager,name:u.hrManager.name,desig:u.hrManager.designation,sub:"",date:"",label:"--"},{show:!!c?.visibility.factoryHead,name:u.factoryHead.name,desig:u.factoryHead.designation,sub:"",date:"",label:"--"},{show:!!c?.visibility.hoHrHead,name:u.hoHrHead.name,desig:u.hoHrHead.designation,sub:"",date:"",label:"--"},{show:!!c?.visibility.headOfOperations,name:u.headOfOperations.name,desig:u.headOfOperations.designation,sub:"",date:"",label:"--"}].filter(l=>l.show&&l.name),N=D.length,M=l=>N===1?"left":N===2?l===0?"left":"right":l===0?"left":l===N-1?"right":"center";return e.jsx("div",{style:{display:"flex",flexWrap:"wrap",justifyContent:N===1?"flex-start":"space-between",gap:"30px 15px",marginTop:"60px",width:"100%",pageBreakInside:"avoid"},children:D.map((l,y)=>e.jsxs("div",{style:{textAlign:M(y),flex:N===1?"0 1 250px":`0 1 calc(${100/N}% - 20px)`,minWidth:"180px",maxWidth:N===1?"250px":"300px"},children:[!o&&e.jsx("p",{style:{fontWeight:"bold",marginBottom:"8px",fontSize:"12px",color:"#333"},children:l.label}),e.jsx("div",{style:{height:o?"64px":"52px"}}),e.jsxs("div",{style:{borderTop:"2px solid black",paddingTop:"8px",width:"100%"},children:[e.jsx("p",{style:{fontWeight:"bold",fontSize:o?"20px":"18px",marginBottom:"2px",color:"#000"},children:l.name}),e.jsx("p",{style:{fontSize:o?"18px":"16px",color:"#444",marginBottom:l.sub?"1px":"3px"},children:l.desig}),l.sub&&e.jsx("p",{style:{fontSize:o?"16px":"14px",color:"#444",marginBottom:"3px"},children:l.sub}),!o&&e.jsxs("p",{style:{fontSize:"16px",color:"#666",whiteSpace:"nowrap"},children:["তারিখ: ",l.date?H(l.date):"___________"]})]})]},y))})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"print-page",style:{padding:"24px 32px",width:"100%",maxWidth:"100%",margin:"0",backgroundColor:"white",color:"#000",fontFamily:"'Noto Sans Bengali', Arial, sans-serif",boxSizing:"border-box"},children:[e.jsxs("header",{className:"print-header",style:{textAlign:"center",borderBottom:"2px solid black",paddingBottom:"12px",marginBottom:"16px",pageBreakAfter:"avoid"},children:[e.jsx("h1",{style:{fontSize:"20px",fontWeight:"bold",color:"black",marginBottom:"4px",textTransform:"uppercase",letterSpacing:"0.5px",lineHeight:"1.2",wordBreak:"keep-all",whiteSpace:"pre-wrap"},children:t.organizationName||"ORGANIZATION NAME"}),e.jsx("p",{style:{fontSize:"12px",color:"black",marginBottom:"0",lineHeight:"1.4"},children:t.organizationAddress||"Address"})]}),e.jsxs("main",{className:"print-body",style:{minHeight:"50vh"},children:[f("notice")&&e.jsxs("div",{className:"print-single-page",style:{marginBottom:"32px"},children:[e.jsx("div",{style:{textAlign:"center",marginBottom:"50px",pageBreakAfter:"avoid"},children:e.jsx("h3",{style:{fontSize:"30px",fontWeight:"bold",textDecoration:"underline",marginBottom:"4px",lineHeight:"1.3"},children:"অফিস নোটিশ"})}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"baseline",marginBottom:"30px",fontSize:"14px",fontWeight:"600",pageBreakAfter:"avoid"},children:[e.jsxs("div",{style:{lineHeight:"1.4"},children:["সূত্র: ",t.meetingNumber||"N/A"]}),e.jsxs("div",{style:{lineHeight:"1.4"},children:["তারিখ: ",H(t.noticeDate||t.meetingDate)]})]}),e.jsx("div",{style:{marginBottom:"24px"},children:e.jsx(it,{minutes:t})}),t.agendaItems.length>0&&(()=>{const o=t.agendaItems.length,c=o<=5?20:o<=8?17:o<=12?15:13,u=o<=5?1.8:o<=8?1.6:1.4;return e.jsxs("div",{style:{marginBottom:"32px",pageBreakInside:"avoid",marginTop:"10px"},children:[e.jsx("p",{style:{marginBottom:"15px",fontSize:"20px",lineHeight:"1.4",fontWeight:"normal",textDecoration:"underline",textUnderlineOffset:"5px"},children:"আলোচ্যসূচি:"}),e.jsx("ul",{style:{listStyleType:"disc",listStylePosition:"outside",fontSize:`${c}px`,lineHeight:u,margin:"0",padding:"0 0 0 25px"},children:t.agendaItems.map((D,N)=>e.jsx("li",{style:{marginBottom:"8px",fontStyle:"italic",fontWeight:"normal",textAlign:"justify"},children:D.topic||`বিষয় ${N+1}`},N))})]})})(),e.jsx("div",{style:{marginBottom:"20px"},children:e.jsx("p",{style:{fontSize:"20px",lineHeight:"1.4",margin:"0"},children:"ধন্যবাদান্তে,"})}),w&&e.jsx("div",{style:{marginTop:"64px",pageBreakInside:"avoid"},children:b(!0)})]}),!f("notice")&&(f("basic")||f("agenda")||f("attendance"))&&e.jsx("div",{style:{textAlign:"center",marginBottom:"20px",pageBreakAfter:"avoid"},children:e.jsx("h2",{style:{fontSize:"18px",fontWeight:"bold",marginBottom:"0",borderBottom:"2px solid black",display:"inline-block",paddingBottom:"4px",paddingLeft:"16px",paddingRight:"16px",lineHeight:"1.3"},children:(t.meetingTitle||"--")+" এর সভার কার্যবিবরণী"})}),f("basic")&&e.jsxs("div",{style:{marginBottom:"32px",pageBreakInside:"avoid"},children:[e.jsx("h3",{style:{fontWeight:"bold",borderBottom:"2px solid black",paddingBottom:"6px",marginBottom:"16px",fontSize:"15px",lineHeight:"1.3"},children:"সাধারণ তথ্য"}),e.jsx("table",{style:{width:"100%",fontSize:"13px",border:"2px solid black",borderCollapse:"collapse"},children:e.jsx("tbody",{children:d.map(({label:o,value:c},u)=>e.jsxs("tr",{style:u<d.length-1?{borderBottom:"1px solid black"}:{},children:[e.jsxs("td",{style:{fontWeight:"bold",padding:"10px",width:"35%",borderRight:"1px solid black",backgroundColor:"#f9fafb",lineHeight:"1.4"},children:[o,":"]}),e.jsx("td",{style:{padding:"10px",lineHeight:"1.4",fontWeight:o==="সভাপতি"||o==="সচিব"?"600":void 0},children:c})]},u))})}),g.length>0&&e.jsxs("div",{style:{marginTop:"20px",pageBreakInside:"avoid"},children:[e.jsx("h3",{style:{fontWeight:"bold",borderBottom:"2px solid black",paddingBottom:"6px",marginBottom:"16px",fontSize:"15px",lineHeight:"1.3"},children:"মিটিং ছবি"}),e.jsx("div",{style:{display:"grid",gridTemplateColumns:g.length===1?"1fr":"repeat(2, 1fr)",gap:"12px"},children:g.map((o,c)=>e.jsx(at,{src:o,index:c},c))})]}),K(t.generalNotes)&&e.jsxs("div",{style:{marginTop:"20px",pageBreakInside:"avoid"},children:[e.jsx("h3",{style:{fontWeight:"bold",borderBottom:"2px solid black",paddingBottom:"6px",marginBottom:"16px",fontSize:"15px",lineHeight:"1.3"},children:"সভার উদ্বোধনী"}),e.jsx("div",{style:{padding:"12px",border:"1px solid #ccc",borderRadius:"4px",backgroundColor:"#f9fafb",fontSize:"13px",lineHeight:"1.7",textAlign:"justify"},children:q(t.generalNotes)})]})]}),f("attendance")&&e.jsxs("div",{className:"print-single-page",style:{marginBottom:"32px",pageBreakInside:"avoid"},children:[e.jsx("h3",{style:{fontWeight:"bold",borderBottom:"2px solid black",paddingBottom:"6px",marginBottom:"16px",fontSize:"15px",lineHeight:"1.3"},children:"উপস্থিতি তালিকা"}),e.jsxs("p",{style:{fontSize:"12px",marginBottom:"12px",fontWeight:"600",lineHeight:"1.6"},children:["মোট: ",v(a.total)," |  উপস্থিত: ",v(a.present)," |  অনুপস্থিত: ",v(a.absent)," |  উপস্থিতির হার: ",v(a.presentPercentage),"%"]}),e.jsxs("table",{style:{width:"100%",border:"2px solid black",fontSize:"12px",borderCollapse:"collapse"},children:[e.jsx("thead",{children:e.jsx("tr",{style:{backgroundColor:"#e5e7eb"},children:["ক্রম","নাম","পদবি","বিভাগ / সেকশন","কমিটিতে ভূমিকা","উপস্থিতি","স্বাক্ষর"].map((o,c)=>e.jsx("th",{style:{border:"1px solid black",padding:"10px",textAlign:c===0||c>=4?"center":"left",fontWeight:"bold",lineHeight:"1.4",width:c===0?"50px":c===4?"90px":c===5?"100px":c===6?"140px":void 0},children:o},c))})}),e.jsx("tbody",{children:t.attendees.map((o,c)=>e.jsxs("tr",{children:[e.jsx("td",{style:{border:"1px solid black",padding:"10px",textAlign:"center",fontWeight:"600",lineHeight:"1.4"},children:v(c+1)}),e.jsx("td",{style:{border:"1px solid black",padding:"10px",lineHeight:"1.4"},children:o.name}),e.jsx("td",{style:{border:"1px solid black",padding:"10px",lineHeight:"1.4"},children:o.designation}),e.jsx("td",{style:{border:"1px solid black",padding:"10px",lineHeight:"1.4"},children:o.department}),e.jsx("td",{style:{border:"1px solid black",padding:"10px",textAlign:"center",lineHeight:"1.4"},children:o.committeeRole||"—"}),e.jsx("td",{style:{border:"1px solid black",padding:"10px",textAlign:"center",fontWeight:"600",lineHeight:"1.4"},children:Xe(o.attendanceStatus)}),e.jsx("td",{style:{border:"1px solid black",padding:"10px"}})]},c))})]})]}),f("agenda")&&t.agendaItems.length>0&&e.jsxs("div",{style:{marginBottom:"32px"},children:[e.jsx("h3",{style:{fontWeight:"bold",borderBottom:"2px solid black",paddingBottom:"6px",marginBottom:"16px",fontSize:"15px",lineHeight:"1.3"},children:"আলোচ্যসূচি ও সিদ্ধান্ত"}),e.jsxs("table",{style:{width:"100%",border:"2px solid black",borderCollapse:"collapse",fontSize:"12px",tableLayout:"fixed"},children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:"5%"}}),"   ",e.jsx("col",{style:{width:"25%"}}),"  ",e.jsx("col",{style:{width:"31%"}}),"  ",e.jsx("col",{style:{width:"15%"}}),"  ",e.jsx("col",{style:{width:"11%"}}),"  ",e.jsx("col",{style:{width:"13%"}}),"  "]}),e.jsx("thead",{children:e.jsx("tr",{style:{backgroundColor:"#e5e7eb"},children:[{title:"নং",align:"center"},{title:"আলোচ্যসূচি",align:"left"},{title:"আলোচনা ও সিদ্ধান্ত",align:"left"},{title:"দায়িত্ব",align:"left"},{title:"সময়সীমা",align:"center"},{title:"অবস্থা",align:"center"}].map((o,c)=>e.jsx("th",{style:{border:"1px solid black",padding:o.align==="center"?"9px 8px":"9px 10px",textAlign:o.align,fontWeight:"bold",lineHeight:1.5,verticalAlign:"middle"},children:o.title},c))})}),e.jsx("tbody",{children:t.agendaItems.map((o,c)=>{const u=o.decisions[0],D=o.actionItems[0];return e.jsxs("tr",{style:{backgroundColor:c%2===0?"#ffffff":"#fafafa",pageBreakInside:"avoid"},children:[e.jsx("td",{style:{border:"1px solid black",padding:"10px 8px",textAlign:"center",fontWeight:"bold",fontSize:"13px",verticalAlign:"top",lineHeight:"1.4"},children:v(String(c+1).padStart(2,"0"))}),e.jsx("td",{style:{border:"1px solid black",padding:"10px",verticalAlign:"top",lineHeight:"1.7"},children:o.topic?e.jsx("div",{style:{fontWeight:"bold",fontSize:"12px"},children:o.topic}):e.jsx("span",{style:{color:"#aaa"},children:"—"})}),e.jsx("td",{style:{border:"1px solid black",padding:"10px",verticalAlign:"top",lineHeight:"1.7"},children:u?.description?e.jsx("div",{style:{fontSize:"11px",textAlign:"justify"},children:u.description}):e.jsx("span",{style:{color:"#aaa"},children:"—"})}),e.jsx("td",{style:{border:"1px solid black",padding:"10px",verticalAlign:"top",fontSize:"11px",lineHeight:"1.6"},children:D?.assignedTo||e.jsx("span",{style:{color:"#aaa"},children:"—"})}),e.jsx("td",{style:{border:"1px solid black",padding:"10px",verticalAlign:"top",fontSize:"11px",lineHeight:"1.6",textAlign:"center"},children:D?.dueDate?H(D.dueDate):e.jsx("span",{style:{color:"#aaa"},children:"—"})}),e.jsx("td",{style:{border:"1px solid black",padding:"10px",verticalAlign:"top"},children:e.jsx(nt,{status:D?.status??""})})]},c)})})]})]}),f("agenda")&&K(t.closingNotes)&&e.jsxs("div",{style:{marginTop:"24px",pageBreakInside:"avoid"},children:[e.jsx("h3",{style:{fontWeight:"bold",borderBottom:"2px solid black",paddingBottom:"6px",marginBottom:"16px",fontSize:"15px",lineHeight:"1.3"},children:"সভার সমাপনী"}),e.jsx("div",{style:{padding:"12px",border:"1px solid #ccc",borderRadius:"4px",backgroundColor:"#f9fafb",fontSize:"13px",lineHeight:"1.7",textAlign:"justify"},children:q(t.closingNotes)})]})]}),j&&w&&e.jsx("footer",{className:"print-footer",style:{marginTop:"8px",paddingTop:"4px",pageBreakInside:"avoid"},children:b(!1)})]}),e.jsx("style",{children:`
      ...
      `})]})}const rt=[{id:"basic",label:"প্রাথমিক তথ্য",icon:"ti-building"},{id:"opening",label:"উদ্বোধনী ও সমাপনী",icon:"ti-microphone"},{id:"discussion",label:"আলোচনা ও সিদ্ধান্ত",icon:"ti-table"},{id:"photo",label:"সভার ছবি",icon:"ti-photo"},{id:"attendance",label:"উপস্থিতি/অনুপস্থিত",icon:"ti-users"}];function gt(){const{user:t}=de(),n=P(),i=ge("meetings",n.id,t?.name??"unknown"),[r,p]=k.useState(F),[a,h]=k.useState($),[g,x]=k.useState("basic"),s=k.useRef(null),m=g!=="basic"&&g!=="attendance"&&g!=="opening"&&g!=="discussion"&&g!=="photo",f=g==="basic"||g==="attendance"||g==="opening"||g==="discussion"||g==="photo"?g:"basic",j=l=>{const T=(A.find(S=>S.name===l.organizationName)?.committees??A.flatMap(S=>S.committees)).find(S=>S.name===l.meetingTitle);T&&p(S=>({...S,president:T.chairperson,presidentDesignation:"সভাপতি",secretary:T.secretary,secretaryDesignation:"সচিব",visibility:{...S.visibility,president:!0,secretary:!0}}))},w=l=>{h(l),j(l)},d=()=>{i.setEditingId(null),h($),p(F),x("basic")},b=()=>window.print(),o=async()=>{const l=s.current;if(!l)return;const y=await ce(l,{scale:2,useCORS:!0}),T=y.toDataURL("image/png"),S=new pe("p","mm","a4"),C=S.internal.pageSize.getWidth(),ae=y.height*C/y.width;S.addImage(T,"PNG",0,0,C,ae),S.save(`Meeting_Minutes_${a.meetingTitle||"document"}.pdf`)},c=l=>{const y=l.split(`
