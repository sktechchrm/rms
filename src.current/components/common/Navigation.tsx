...
import {
  ...
  FaChartBar, FaIdBadge, FaBookOpen, FaClipboardCheck, FaFileContract, FaFileInvoice, FaBalanceScale, FaTruck, FaGavel,
} from "react-icons/fa";
...
const ALL_HR_MODULES = [
  ...
  { id: "disciplinaryaction", label: "Disciplinary Action", icon: FaGavel },
