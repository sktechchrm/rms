...
// STANDARD DOCUMENT HEADER (point 2 — all module print headers share this
// padding now): 12px padding-bottom, 12px margin-bottom, 2px solid black
// border-bottom. Previously each module had its own value (5px-16px range).
// Apply via className="doc-header-standard" alongside each module's own
// existing classes/inline styles, or match these exact numbers directly.
export const DOC_HEADER_CSS: string = [
  ".doc-header-standard {",
  "  text-align: center;",
  "  padding-bottom: 12px;",
  "  margin-bottom: 12px;",
