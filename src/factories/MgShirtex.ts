  ...
  committees: [
{
  ...
  members: [
    ...
    { name: 'মনিষা আক্তার তৃপ্তি',    gender: 'মহিলা', designation: 'কোয়ালিটি ইন্সপেক্টর',    section: 'কোয়ালিটি', role: 'সদস্য'},
    { name: 'মোসাঃ রাবেয়া',         gender: 'মহিলা', designation: 'সহঃ ফিনিশিং',            section: 'ফিনিশিং',         role: 'সদস্য'},
    { name: 'মোসাঃ রপসানা আক্তার', gender: 'মহিলা', designation: 'অপারেটর',                section: 'সুইং',          role: 'সদস্য'},
...

    {
      ...
      secretaryDept:          'এইচ আর এডমিন এন্ড কমপ্লায়েন্স', 
      establishDate:          '2022-12-24',
      members: [
        { name: 'মোছাঃ ডলি আক্তার',      gender: 'মহিলা', designation: 'অপারেটর',                   section: 'সুইং',    role: 'সহ-সভাপতি' },
        { name: 'মোঃ ফরিদ আহমেদ',        gender: 'পুরুষ',  designation: 'জুনিঃ সুপারভাইজার',        section: 'সুইং',    role: 'সদস্য' },
        { name: 'নাসির হোসেন',             gender: 'পুরুষ',  designation: 'অপারেটর',                section: 'সুইং',    role: 'সদস্য' },
        { name: 'মোছাঃ শাহানাজ শানু',     gender: 'মহিলা', designation: 'সিঃ অপারেটর',              section: 'সুইং',     role: 'সদস্য' },
        { name: 'মোঃ আইয়ুব আলী',         gender: 'পুরুষ',  designation: 'সিঃ কোয়ালিটি ইন্সপেক্টর',   section: 'কোয়ালিটি', role: 'সদস্য' },
        { name: 'সুস্মিতা রানী মজুমদার', gender: 'মহিলা', designation: 'সুপারভাইজার',                  section: 'সুইং',     role: 'সদস্য' },
      ],
    },

    {
      ...
      chairpersonGender:      'মহিলা',
      chairpersonDesignation: 'ওয়েলফেয়ার অফিসার',
      chairpersonDept:        'এইচআর এডমিন এন্ড কমপ্লায়েন্স',
      secretary:              'কুলসুম',
      secretaryGender:        'মহিলা',
      secretaryDesignation:   'কোয়ালিটি ইন্সপেক্টর',
      secretaryDept:          'কোয়ালিটি',
      establishDate:          '2019-05-09',
      validYear:              '2',
      members: [
        { name: 'মোঃ শফিকুল ইসলাম',   gender: 'পুরুষ',  designation: 'কোয়ালিটি ইন্সপেক্টর', section: 'কোয়ালিটি',                          role: 'সহ-সভাপতি' },
        { name: 'মোছাঃ শিল্পি আক্তার',    gender: 'মহিলা', designation: 'অপারেটর',               section: 'সুইং',                          role: 'সদস্য' },
        { name: 'রওশনা আরা',           gender: 'মহিলা', designation: 'সহঃ ব্যবস্থাপক',        section: 'নারী পক্ষ',                        role: 'সদস্য' },
        { name: 'আমেনা দেওয়ান',        gender: 'মহিলা', designation: 'আইনজীবি',               section: 'লেবারকোট',                    role: 'আইনি উপদেষ্টা' },
        { name: 'মোঃ ছায়রুল ইসলাম',   gender: 'পুরুষ',  designation: 'সহ-ব্যবস্থাপক',        section: 'এইচআর এডমিন এন্ড কমপ্লায়েন্স',        role: 'সদস্য' },
      ],
    },
  ],
};