// ─────────────────────────────────────────────────────────────────────────────
// MG APPARELS — Complete factory definition
// Edit ONLY this file to update anything about MG APPARELS across the entire app.
// ─────────────────────────────────────────────────────────────────────────────
...
export const MG_APPARELS: FactoryConfig = {
  ...
  addressEn: 'H-240, Bhuiyanpara, Siddhirganj, Narayanganj-1430.',
  addressBn: 'এইচ-২৪০, ভূঁইয়াপাড়া, সিদ্ধিরগঞ্জ, নারায়নগঞ্জ-১৪৩০।',
  active:    true,
  ...
  authorities: {
    ...
    factoryHead: {
      name:          'কেশব চন্দ্র মজুমদার',
      nameEn:        'Kasab Chandra Mojumder',
      designation:   'সিনি: জেনারেল ম্যানেজার (কারখানা প্রধান)',
      designationEn: 'Sr. General Manager (Factory Head)',
      email:         '',
      phone:         '',
    },
    hrManager: {
      ...
      designation:   'এ.জি.এম  (মানবসম্পদ, প্রশাসন ও কমপ্লায়েন্স)',
      designationEn: 'AGM (HR, Admin & Compliance)',
      email:         '',
      phone:         '',
    },
    hoHrHead: {
  ...
  // ════════════════════════════════════════════════════════════════════════════
  meetingAuthorities: [
    { name: 'মোঃ কামাল হোসেন',   designation: 'এ.জি.এম  (মানবসম্পদ, প্রশাসন ও কমপ্লায়েন্স)' },
    { name: 'কেশব চন্দ্র মজুমদার', designation: 'সিনিয়র ব্যবস্থাপক (কারখানা প্রধান)' },
  ],
